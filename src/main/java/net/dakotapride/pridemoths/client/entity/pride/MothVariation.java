...
public enum MothVariation implements StringRepresentable {
    DEFAULT(0, "default"),
    RARE(1, "rare"),
    ...
    static {
        INDEX_MAPPER = ByIdMap.continuous(MothVariation::getIndex, MothVariation.values(), ByIdMap.OutOfBoundsStrategy.ZERO);
        CODEC = StringRepresentable.fromEnum(MothVariation::values);
